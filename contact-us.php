                ...
                <form  method="POST" id="enquiry_form" action="mail.php">
                    ...
                    <div class="width-800">
                            ...
                            <div class="form-flex">
                                <div class="frm-inner-flx-50">
                                    <div class="singel-input">
                                        ...
                                        <input type="text" name="first_name"  placeholder="<?= $langArr['Enter_Your_First_Name'] ?>">
                                    </div>
                                </div>
                                <div class="frm-inner-flx-50">
                                    <div class="singel-input">
                                        <label for="last-name"><?= $langArr['Last_Name'] ?>*</label>
                                        <input type="text" name="last_name" placeholder="<?= $langArr['Enter_Your_Last_Name'] ?>">
                                    </div>
                                </div>
                                <div class="frm-inner-flx-100">
                                    <div class="singel-input">
                                        <label for="email"><?= $langArr['Email'] ?>*</label>
                                        <input type="email" name="email"  placeholder="<?= $langArr['Enter_Your_Email_Id'] ?>">
                                    </div>
                                </div>
                                <div class="frm-inner-flx-100">
                                    <div class="singel-input">
                        ...
                        <div class="submit-btn">
                            ...
                            <!-- <a href="index.php" class="btn primary-btn"></a> -->
                        </div>
                    </div>
